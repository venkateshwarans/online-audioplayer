...
<div class="flex justify-center flex-col gap-y-3.5">
  <h1 class="mx-auto">
    Enter URL
  </h1>
  <div class="input-container relative bg-white rounded-xl w-full shadow-normal mb-12 topics-active max-w-lg mx-auto shadow  rounded-xl">

    <input class="box-border block w-full text-p-medium h-small pl-11 pr-3 py-2 border border-transparent leading-5 text-gray-600  rounded-md placeholder-gray-500 focus:outline-none focus:bg-none focus:border-white focus:ring-white focus:text-gray-900 text-left py-7 sm:pl-medium h-14 ds-input" type="text" bind:value={src} on:change={handleChange}>
  </div>
</div>
